  ...
  return (
    <div style={styles.cardContainer}>
      <div style={styles.textContainer}>
        ...
        Desenvolvo testes automatizados utilizando Java, Javascript e SQL, com as ferramentas de automação como Cypress, Selenium, RestAssured, Postman, Insomnia, TestNG e JUnit.  
...
Tenho conhecimento em desenvolvimento de software com metodologias ágeis e em cascata.</p>
      </div>
    </div>
  );
};
